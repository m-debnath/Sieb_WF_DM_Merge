...
public class AddNewSrchSpecNew extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddNewSrchSpecNew dialog = new AddNewSrchSpecNew();
	 ...
	 * Create the dialog.
	 */
	public AddNewSrchSpecNew() {
		super();
	}

	public AddNewSrchSpecNew(Dialog dialog, String ExpBC, ArrayList<String> ListOfFieldSequence) {
