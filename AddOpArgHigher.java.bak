...
public class AddOpArgHigher extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddOpArgHigher dialog = new AddOpArgHigher();
	 ...
	 * Create the dialog.
	 */
	public AddOpArgHigher() {
		super();
	}

	public AddOpArgHigher(Dialog dialog, ArrayList<RepositoryWfProcessProp> listOfRepositoryWfProcessPropMerged, ArrayList<String> ListOfPropertyName, ArrayList<String> ListOfFieldSequence) {
