...
public class AddNewInputArgNew extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddNewInputArgNew dialog = new AddNewInputArgNew();
	 ...
	 * Create the dialog.
	 */
	public AddNewInputArgNew() {
		super();
	}

	public AddNewInputArgNew(Dialog dialog, ArrayList<RepositoryWfProcessProp> listOfRepositoryWfProcessPropMerged, ArrayList<String> ListOfInpArgName, ArrayList<String> ListOfFieldSequence) {
