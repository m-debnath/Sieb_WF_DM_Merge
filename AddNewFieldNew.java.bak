...
public class AddNewFieldNew extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddNewFieldNew dialog = new AddNewFieldNew();
	 ...
	 * Create the dialog.
	 */
	public AddNewFieldNew() {
		super();
	}
	public AddNewFieldNew(Dialog dialog, ArrayList<RepositoryWfProcessProp> listOfRepositoryWfProcessPropMerged, ArrayList<String> ListOfFieldName, ArrayList<String> ListOfFieldSequence) {
