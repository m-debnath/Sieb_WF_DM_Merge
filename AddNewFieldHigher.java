...
public class AddNewFieldHigher extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddNewFieldHigher dialog = new AddNewFieldHigher();
	 ...
	 * Create the dialog.
	 */
	public AddNewFieldHigher() {
		super();
	}
	public AddNewFieldHigher(Dialog dialog, ArrayList<RepositoryWfProcessProp> listOfRepositoryWfProcessPropMerged, ArrayList<String> ListOfFieldName, ArrayList<String> ListOfFieldSequence) {
