...
public class AddOpArgNew extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddOpArgNew dialog = new AddOpArgNew();
	...
	public AddOpArgNew(Dialog dialog, ArrayList<RepositoryWfProcessProp> listOfRepositoryWfProcessPropMerged, ArrayList<String> ListOfPropertyName, ArrayList<String> ListOfFieldSequence) {
