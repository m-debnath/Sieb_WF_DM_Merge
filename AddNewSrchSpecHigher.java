...
public class AddNewSrchSpecHigher extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddNewSrchSpecHigher dialog = new AddNewSrchSpecHigher();
	 ...
	 * Create the dialog.
	 */
	public AddNewSrchSpecHigher() {
		super();
	}

	public AddNewSrchSpecHigher(Dialog dialog, String ExpBC, ArrayList<String> ListOfFieldSequence) {
