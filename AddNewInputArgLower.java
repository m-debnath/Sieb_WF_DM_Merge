...
public class AddNewInputArgLower extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			AddNewInputArgLower dialog = new AddNewInputArgLower();
	 ...
	 * Create the dialog.
	 */
	public AddNewInputArgLower() {
		super();
	}

	public AddNewInputArgLower(Dialog dialog, ArrayList<RepositoryWfProcessProp> listOfRepositoryWfProcessPropMerged, ArrayList<String> ListOfInpArgName, ArrayList<String> ListOfFieldSequence) {
